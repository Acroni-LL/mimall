          ...
          <div class="item-good">
            ...
            <ul>
              ...
              <li>
                <div class="good-name">
                  <img
                    src="/imgs/item-box-3-1.png"
                    alt=""
                  >
                  <span>小米8 6GB 全息幻彩紫 64GB</span>
                </div>
                <div class="good-price">{{item.productPrice}}yuanX{{item.quantity}}</div>
...
export default {
  ...
  data () {
    return {
      list: [],//address
      cartList: [],
      cartTotalPrice: 0,//goods
      count: 0,
      checkedItem: {},
      userAction: '',//用户行为，0:add   1:edit  2：del  
      showDelModal: false
    }
  },
  components: {
